...
- **server/**: Express-basiertes Backend mit Sequelize-Datenbankadapter (SQLite standardmäßig, PostgreSQL/MariaDB/MySQL optional), Regel-Cache, normalisierter Key/Value-Persistenz für allgemeine Einstellungen und dateibasiertem Session-Handling.
