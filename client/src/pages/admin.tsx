                      ...
                      <>
                        <div className="overflow-x-auto">
                          <table className="w-full table-fixed min-w-[1000px]">
                            <thead className="bg-muted/50 border-b">
                              <tr>
                                <th className="text-left p-3 relative" style={{ width: statsColWidths.timestamp }}>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                ...
                                <th className="text-left p-3 relative" style={{ width: statsColWidths.oldUrl }}>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                ...
                                <th className="text-left p-3 relative" style={{ width: statsColWidths.newUrl }}>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                ...
                                <th className="text-left p-3 relative" style={{ width: statsColWidths.path }}>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                ...
                                <th className="text-left p-3 relative" style={{ width: statsColWidths.matchQuality }}>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                ...
                                <th className="text-left p-3 font-medium text-sm relative" style={{ width: statsColWidths.rule }}>
                                ...
                                <tr key={entry.id} className="border-b hover:bg-muted/50">
                                  ...
                                  <td className="p-3">
                                    <div className="w-full" title={entry.oldUrl}>
                                      <code className="text-xs text-foreground bg-muted/50 px-1 py-0.5 rounded inline-block max-w-full truncate align-middle">
                                        {entry.oldUrl}
                                      </code>
                                    </div>
                                  </td>
                                  ...
                                  <td className="p-3">
                                    <div className="w-full" title={entry.path}>
                                      <code className="text-sm text-foreground bg-muted/50 px-1 py-0.5 rounded inline-block max-w-full truncate align-middle">
                                        {entry.path}
                                      </code>
                                    </div>
                                  </td>
