...
export class FileStorage implements IStorage {
  ...
  async getTrackingStats() {
    ...
    // Bolt: Execute independent queries concurrently to avoid sequential blocking and reduce total wait time
    const [total, todayCount, weekCount, match100, match75, match50, match0, ok, nok, autoRedirect] = await Promise.all([
