...
export class FileStorage implements IStorage {
  ...
  async getTrackingStats() {
    ...
    // ⚡ Bolt: Optimize performance by executing 10 independent database queries concurrently using Promise.all
    // This removes sequential blocking and reduces overall latency to approximately the duration of the slowest single query.
    const [
      total,
      todayCount,
      weekCount,
